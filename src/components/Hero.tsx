...
export function Hero() {
  return (
    <section id="hero" className="relative text-center text-white py-24 md:py-32 px-6">
      <h1 className="neon-cyan text-5xl md:text-7xl font-bold tracking-wider mb-3">HackDartmouth</h1>
      <p className="text-cyan-200 text-xl md:text-2xl tracking-widest uppercase mb-4">lost in space</p>
      <p className="text-slate-200 text-lg md:text-xl mb-2">April 26 to 27, 2026 | Dartmouth College</p>
      <p className="text-slate-300 text-sm md:text-base uppercase tracking-[0.2em] mb-10">24 Hours | $8000 in Prizes</p>
